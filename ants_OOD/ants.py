...
class Place:
    ...
    def remove_insect(self, insect):
        ...
        if type(insect) == QueenAnt and insect.my_count == 1:
            return
...
class QueenAnt(ScubaThrower):
    ...
    def __init__(self):
        ...
        self.my_count = QueenAnt.queen_count
    ...
    def action(self, colony):
        ...
        current_place = self.place
        while current_place:
            if current_place.ant and current_place.ant not in self.doubled_ants and type(current_place.ant) != QueenAnt:
                current_place.ant.damage *= 2
                self.doubled_ants.append(current_place.ant)
                if type(current_place.ant) == BodyguardAnt and type(current_place.ant.ant) != QueenAnt and current_place.ant.ant not in self.doubled_ants:
